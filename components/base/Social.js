...
export default function Social({ onLoad = () => {}, ...props }) {
  return (
    <>
      <div className="h-[20%] w-full float-left ">
        ...
        <div className="h-full w-[50%] float-left">
          <div className="float-right w-[80px] h-full border-black border-l-2">
            <CustomImage
              src="/images/help.svg"
              className="h-8 mt-5 ml-5"
            />
          </div>
          <div className = "float-right h-full w-[100px] border-black border-l-2" >
      ...
      <div className="h-[80%] w-full float-left  border-black border-t-2 border-l-2">
        <div className="h-[80%] w-[60%] float-left mt-7 border-black border-r-2">
          ...
          <div className="text-[18px]  w-[60%] h-full float-left">
              <div>Registered a year ago</div>
              <div>Follows: 5231</div>
          </div>
          </div>
          <div className="h-[90%] w-[40%] float-left mt-7">
              Posts
          </div>
      </div>
    </>

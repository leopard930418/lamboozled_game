...
export default function Day1({curArtIndex = 0 ,meter=50, handleIsFeed, handleMarked}) {
// game logic
  ...
  return (
    <>
      ...
      >
        ...
        {/* <div className="fixed  left-1/2 -translate-x-1/2 translate-y-1 bottom-0 bg-gradient-to-b from-[#FF7575] to-[#FFD0D0] pt-6 w-[800px]">
                    <img
